 ...
 * @author litchar
 */
public class refinanceCalc11 extends javax.swing.JFrame {

    /**
     * Creates new form refinanceCalc
     */;
    public refinanceCalc11() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/shrunkCalcLogo(.96).png"))); // NOI18N
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (costs == 0) {
            ...
            APR = refinanceHelper.findAPR(remainingBalance, monthlyAmt, newLoanTerm, costs);
        }
        
        double diff =  100 * Math.abs(APR - oldInterestRate);
        APR *= 100;
        oldInterestRate *= 100;
        ...
        if (costs == 0) {
            ...
            System.out.print("amt left: " + amtLeft+ "\n");
            System.out.print("monthly pay: " + newMonthlyAmt+ "\n");
            APR = refinanceHelper.findAPR(amtLeft, newMonthlyAmt, newLoanTerm, costs);
        }
        double diff =  100 * Math.abs(APR - oldInterestRate);
